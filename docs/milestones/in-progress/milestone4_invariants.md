...
> Slice J vendors a narrowed AppArmor profile to close this; invariants 37–38 below are its checkable
> properties and are **not yet built**. Until then the jail fails **closed** on such hosts (invariant
> 32 holds — it refuses to start rather than running unjailed), which makes this a reach limitation
> rather than a silent boundary hole.
